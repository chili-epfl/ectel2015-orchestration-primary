...
# Files from each session should be called [session]-eventexport.txt, [session]-fixationDetails, [session]-saccadeDetails.txt
aggregateEpisodeData <- function(sessions, datadir="."){
    ...
    print("Aggregation into 10-second episodes finished. Writing clean datafile: ISL2014BASELINE-AggregatedEyetrackData.Rda")
    save(totaldata,file="ISL2014BASELINE-AggregatedEyetrackData.Rda")
